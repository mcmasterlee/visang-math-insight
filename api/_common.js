const {CATALOG,bookKey,collectBook,publicRecord,testNaver,testOpenAI}=require('../lib/core');
...
module.exports={CATALOG,bookKey,publicRecord,testNaver,testOpenAI,getRecord,storageMode,getConfig,send,refreshBook};
